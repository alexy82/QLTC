...
from QuanLyTiecCuoi.serializers.group import GroupSerializer
from QuanLyTiecCuoi.views.base import BaseITSAdminView, BaseCheckPermission
...
class GroupEditView(BaseITSAdminView):
    ...
    def get(self, request, group_id, **params):
        ...
        selected_permissions = Permission.objects.filter(Q(group=group), Q(content_type__app_label='QuanLyTiecCuoi') | Q(
            content_type__app_label='auth'))
